...
public class SwapGate extends Matrix {
    ...
    public SwapGate() {
        ...
        setValue(1, 2, ComplexNumber.ONE);
        setValue(1, 3, ComplexNumber.ZERO);

        setValue(2, 0, ComplexNumber.ZERO);
        setValue(2, 1, ComplexNumber.ONE);
        setValue(2, 2, ComplexNumber.ZERO);
        setValue(2, 3, ComplexNumber.ZERO);

        setValue(3, 0, ComplexNumber.ZERO);
        setValue(3, 1, ComplexNumber.ZERO);
        setValue(3, 2, ComplexNumber.ZERO);
        setValue(3, 3, ComplexNumber.ONE);
    }

    /**
     * Returns the matrix form of the swap gate.
     * @return 
     */
